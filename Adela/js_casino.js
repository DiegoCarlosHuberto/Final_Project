...
function slot() {
    ...
    http.open("GET", "http://127.0.0.1:8080/ProyectoCasino/SlotGame", true);
    http.send();
...
function bet() {
    ...
    http.open("POST", "http://127.0.0.1:8080/ProyectoCasino/SlotGame", true);
...
function login() {
    ...
    http.open("POST", "http://localhost:8080/ProyectoCasino/LoginAccess", true);
    http.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
function newUser() {
    ...
    http.open("POST", "http:/localhost:8080/ProyectoCasino/CreateUser", true);
    http.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
function ingresar() {
    ...
    if (user == null) {
        ...
        http.open("POST", "http:/localhost:8080/ProyectoCasino/InsertCredit", true);
        http.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
function ApostarR() {
  ...
  http.open(
    "GET",
    "http://localhost:8080/ProyectoCasino/Conexion?nums=" +
...
function betR() {
  ...
  http.open("POST", "http://127.0.0.1:8080/ProyectoCasino/Conexion", true);
  http.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  http.send(
    "moneyN=" +
      document.getElementById("moneyNum").value +
